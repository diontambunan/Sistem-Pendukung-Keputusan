...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Des 2019 pada 15.18
...
(7, 'administrator', 'admin', 'admin@pmi.co.id', '085210245333', 'admin');

-- --------------------------------------------------------

--
-- Struktur dari tabel `donor_darah`
--
...
--
-- Dumping data untuk tabel `donor_darah`
--
...
--
-- Struktur dari tabel `mamdani`
--

CREATE TABLE `mamdani` (
...
--
-- Dumping data untuk tabel `mamdani`
--
...
--
-- Struktur dari tabel `produksi_darah`
--

CREATE TABLE `produksi_darah` (
...
--
-- Dumping data untuk tabel `produksi_darah`
--
...
--
-- Indeks untuk tabel `donor_darah`
--
ALTER TABLE `donor_darah`
  ADD PRIMARY KEY (`id_donor`);

--
-- Indeks untuk tabel `mamdani`
--
ALTER TABLE `mamdani`
...
--
-- Indeks untuk tabel `produksi_darah`
--
...
--
-- AUTO_INCREMENT untuk tabel `donor_darah`
--
ALTER TABLE `donor_darah`
  MODIFY `id_donor` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT untuk tabel `mamdani`
--
ALTER TABLE `mamdani`
...
--
-- AUTO_INCREMENT untuk tabel `produksi_darah`
--
ALTER TABLE `produksi_darah`
